...
WebUI.click(findTestObject('Page_Si Paling Belajar  MySkill 22/a_Profil'))
...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_Profile Saya  MySkill/input_confirmNewPassword'), '2BMhfH5fbFAt8M8k7vczCA==')

WebUI.click(findTestObject('Object Repository/Page_Profile Saya  MySkill/button_Ubah Password_1'))

WebUI.click(findTestObject('Object Repository/Page_Profile Saya  MySkill/div_Password kamu telah berhasil diubah'))

WebUI.click(findTestObject('Object Repository/Page_Profile Saya  MySkill/button_Tutup'))
